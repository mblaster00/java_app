					  ...
					  <header id="header" id="home">
					    <div class="container">
					    	<div class="row align-items-center justify-content-between d-flex">
						      <div id="logo">
						        <a href="search.html"><h4 style="color: white;">Sama Transport</h4></a>
						      </div>
						...
						<div class="container">
							<div class="row fullscreen d-flex align-items-center justify-content-center">
								...
								<div id="myDIV" class="col-lg-5 col-md-6 header-right">
									<h4 class="text-white pb-30">Filtrer</h4>
									<form class="form" role="form" autocomplete="off">
		                                ...
		                                <div class="from-group">
											<input class="form-control txt-field" type="text" name="destination" placeholder="Indiquer votre destination">
									    </div>
